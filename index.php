...
<body
            ...
            <div class="animate-fade-in">
                ...
                <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4 animate-slide-up"
                    ...
                    <button onclick="document.getElementById('chatToggle').click()"
                        class="px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-2xl shadow-lg shadow-primary-500/30 hover:shadow-primary-500/40 transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center">
    ...
    <div id="chatInterface"
        ...
        <!-- Chat Header -->
        <div
            class="bg-gradient-to-r from-primary-600 to-emerald-600 text-white p-5 flex justify-between items-center shadow-md relative overflow-hidden">
            ...
            <button id="closeChat"
                class="w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors relative z-10">
            ...
            <div class="animate-fade-in">
                <div class="ai-bubble chat-bubble relative group">
                    ...
                    <div class="flex items-center mb-2">
                        <div
                            class="w-6 h-6 rounded-lg bg-primary-100 flex items-center justify-center mr-2 text-primary-600">
    ...
    <script>
        ...
        document.getElementById('chatToggle').addEventListener('click', () => {
            ...
            if (isChatOpen) {
                chat.classList.remove('invisible', 'opacity-0', 'scale-0');
                chat.classList.add('visible', 'opacity-100', 'scale-100');
                document.getElementById('chatInput').focus();
            } else {
                chat.classList.remove('visible', 'opacity-100', 'scale-100');
                chat.classList.add('invisible', 'opacity-0', 'scale-0');
            }
        });

        // Close chat
        document.getElementById('closeChat').addEventListener('click', () => {
            document.getElementById('chatInterface').classList.remove('visible', 'opacity-100', 'scale-100');
            document.getElementById('chatInterface').classList.add('invisible', 'opacity-0', 'scale-0');
            isChatOpen = false;
        });
